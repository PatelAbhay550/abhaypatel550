...
const FourumCard = ({ projects, onHover, onLeave }) => {
  ...
  return (
    <>
        ...
        <div className="flex items-start justify-between p-6 pb-4">
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              />
              <span className="absolute -bottom-1 -right-1 block size-3 rounded-full border-2 border-white bg-blue-500"></span>
            </div>
          ...
          <div className="space-y-1">
            {projects.map((project) => (
              ...
              >
                ...
                <span className="text-gray-300 group-hover:text-blue-600 transition-all transform group-hover:translate-x-1">→</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Draggable Modal for Project Details */}
